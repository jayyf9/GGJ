...
$sql="SELECT * FROM Items INNER JOIN Gemstones ON Items.Item_GEMID=Gemstones.Gem_ID WHERE Item_ID = $ID";
...
<body>
<div id="container">
<form action="AddItemProcess.php" method="post" enctype="multipart/form-data"><h1>Edit an item:</h1>
